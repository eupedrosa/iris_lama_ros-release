## iris_lama_ros (noetic) - 1.3.2-1

The packages in the `iris_lama_ros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic iris_lama_ros` on `Fri, 09 Sep 2022 10:00:39 -0000`
